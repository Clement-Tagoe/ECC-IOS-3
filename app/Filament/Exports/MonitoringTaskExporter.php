...
class MonitoringTaskExporter extends Exporter
{
    ...
    {
        $body = 'Your monitoring task export has completed and ' . Number::format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
