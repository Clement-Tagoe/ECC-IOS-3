    ...
    public static function getColumns(): array
    {
        return [
            ExportColumn::make('id')
                ->label('ID'),
            ExportColumn::make('incoming_calls'),
            ExportColumn::make('total_calls_received'),
            ExportColumn::make('valid_calls'),
            ExportColumn::make('prank_calls'),
            ExportColumn::make('unanswered_calls'),
